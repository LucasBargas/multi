...
const FaqList = () => {
  return (
    <S.FaqListArea>
      <li>
        <S.FaqAsk>
          <S.FaqIcon>{<BiHelpCircle />}</S.FaqIcon>
      ...
      <li>
        ...
        <S.FaqAnswer>
          Aperiam itaque sit optio et deleniti eos nihil quidem cumque. Voluptas
          dolorum accusantium sunt sit enim. Provident consequuntur quam aut
          reiciendis qui rerum dolorem sit odio. Repellat assumenda soluta sunt
